...
def Insert_data(mycursor, ObjectList1, ObjectList2):
    ...
    for category in ObjectList2:
        category_insertion = "INSERT INTO Category_table (Category_id, Category_name, Translated_name) VALUES(%s, %s, %s)"
    ...
    ADD CONSTRAINT fk_category_id FOREIGN KEY (category_id) REFERENCES Category_table(Category_id);""")
